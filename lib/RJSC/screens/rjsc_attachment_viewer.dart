...
class RJSCAttachmentViewer extends StatefulWidget {
  final String attachmentId;
  final String jwtToken;

  const RJSCAttachmentViewer({
    super.key,
  ...
  @override
  State<RJSCAttachmentViewer> createState() => _RJSCAttachmentViewerState();
}

class _RJSCAttachmentViewerState extends State<RJSCAttachmentViewer> {
  Uint8List? fileBytes;
  String? contentType;
  String? tempFilePath;
  String? webUrl;
  ...
  Future<void> loadAttachment() async {
    final url = Uri.parse(
      '${BASE_URL.Urls().baseURL}rjsc/attachment/view/${widget.attachmentId}',
    );
