...
class ShareholderAttachmentViewer extends StatefulWidget {
  final String attachmentId;
  final String jwtToken;

  const ShareholderAttachmentViewer({
    super.key,
  ...
  @override
  State<ShareholderAttachmentViewer> createState() => _ShareholderAttachmentViewerState();
}

class _ShareholderAttachmentViewerState extends State<ShareholderAttachmentViewer> {
  Uint8List? fileBytes;
  String? contentType;
  String? tempFilePath;
  String? webUrl;
