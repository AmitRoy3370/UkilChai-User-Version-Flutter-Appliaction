// lib/Trademark/widgets/make_tm_payment_sheet.dart
...
const String kTmReceiverPhone = '+8801874648472';

class MakeTmPaymentSheet extends StatefulWidget {
  final String trademarkId;
  final double remainingAmount;
  final double totalFee;

  const MakeTmPaymentSheet({
    super.key,
  ...
  @override
  State<MakeTmPaymentSheet> createState() => _MakeTmPaymentSheetState();
}

class _MakeTmPaymentSheetState extends State<MakeTmPaymentSheet> {
  ...
  Future<void> _submit() async {
    ...
    final payment = TrademarkPaymentModel(
      senderUserId: userId,
      senderPhoneNumber: _phoneController.text.trim(),
      receiverPhoneNumber: kTmReceiverPhone,
    ...
    final res = await TrademarkPaymentService.addPayment(
      userId: userId,
      payment: payment,
    );
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Send money to $kTmReceiverPhone and enter transaction ID below.',
                  style:
