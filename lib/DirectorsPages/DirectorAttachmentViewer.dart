...
class DirectorAttachmentViewer extends StatefulWidget {
  final String attachmentId;
  final String jwtToken;

  const DirectorAttachmentViewer({
    super.key,
  ...
  @override
  State<DirectorAttachmentViewer> createState() => _DirectorAttachmentViewerState();
}

class _DirectorAttachmentViewerState extends State<DirectorAttachmentViewer> {
  Uint8List? fileBytes;
  String? contentType;
  String? tempFilePath;
  String? webUrl;
