...
class CompanyAttachmentViewer extends StatefulWidget {
  final String attachmentId;
  final String jwtToken;

  const CompanyAttachmentViewer({
    super.key,
  ...
  @override
  State<CompanyAttachmentViewer> createState() => _CompanyAttachmentViewerState();
}

class _CompanyAttachmentViewerState extends State<CompanyAttachmentViewer> {
  Uint8List? fileBytes;
  String? contentType;
  String? tempFilePath;
  String? webUrl;
