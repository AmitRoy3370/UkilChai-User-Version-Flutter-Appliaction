                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _infoRow("Client", widget.caseModel.userFullName ?? widget.caseModel.userName, icon: Icons.person),
                      _infoRow("Advocate", (widget.caseModel.advocateFullName ?? widget.caseModel.advocateName) ?? "Not Assigned", icon: Icons.gavel),
                          ...
                          onPressed: () async {
                            ...
                            _navigateWithRandomTransition(
                              ...
                              CaseTracking(
                                ...
                                caseLawyer: widget.caseModel.advocateFullName ?? widget.caseModel.advocateName,
                                issuedTime: widget.caseModel.issuedTime,
                                token: token,
                                advocateUserId: advocateUserId,
                                userName: widget.caseModel.userFullName ?? widget.caseModel.userName,
