...
class DocumentDraftAttachmentView extends StatefulWidget {
  final String attachmentId;
  final String jwtToken;

  const DocumentDraftAttachmentView({
    super.key,
...
class _DocumentDraftAttachmentViewState extends State<DocumentDraftAttachmentView> {
  ...
  Future<void> loadAttachment() async {
    final url = Uri.parse(
      '${BASE_URL.Urls().baseURL}document-draft/attachment/view/${widget.attachmentId}',
    );
